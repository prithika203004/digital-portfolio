...
<body>
        <header>
            <div class="header-content">
               ...
               <img src="Prithika.A.jpeg" alt="your profile picture" class="profile=picture">
               <h1>PRITHIKA</h1>
            ...
            <section id="about">
                <div class="section-content">
                     <h2>About Me</h2>
                     <p>Hello Everyone! This is PRITHIKA A and i am a computer science learner.</p>
                </div>
            </section>
